...
/**
 * @rule interactAt: 交互时间, hours: 小时, days: 天
 */
class InteractAt extends Rule
{
    /**
     * @var array|string[]
     */
    protected $validationRules = [
        'field' => 'require|eq:interactAt', 'calc' => 'require|in:between', 'value' => 'require|array|length:1,2', 'unit' => 'require|in:hour,day,-'
    ];
    ...
    public function getSqlSegment(int $dbmsType = SqlBuilder::MySQL): string
    {
        ...
        $field = $this->getField('operate_time');
