...
/**
 * @rule activateAt: 活跃时间, hours: 小时, days: 天
 */
class ActivateAt extends Rule
{
    /**
     * @var array|string[]
     */
    protected $validationRules = [
        'field' => 'require|eq:activateAt', 'calc' => 'require|in:between', 'value' => 'require|array|length:1,2', 'unit' => 'require|in:hour,day,-'
    ];
    ...
    public function getSqlSegment(int $dbmsType = SqlBuilder::MySQL): string
    {
        ...
        $field = $this->getField('activate_time');
