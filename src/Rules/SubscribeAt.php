...
/**
 * @rule subscribeAt: 关注时间, hours: 小时, days: 天
 */
class SubscribeAt extends Rule
{
    /**
     * @var array|string[]
     */
    protected $validationRules = [
        'field' => 'require|eq:subscribeAt', 'calc' => 'require|in:between', 'value' => 'require|array|length:1,2', 'unit' => 'require|in:hour,day,-'
    ];
    ...
    public function getSqlSegment(int $dbmsType = SqlBuilder::MySQL): string
    {
        ...
        $field = $this->getField('subsribe_time');
